...
import { getDbSaicleGlobalPath } from "../../../util/paths.js";
...
const ShareSlashCommand: SlashCommand = {
  ...
  run: async function* ({ ide, history, params }) {
    ...
    let content = `### [DbSaicle](https://dbsaicle.dev) session transcript\n Exported: ${now.toLocaleString()}`;
    ...
    let outputDir: string = params?.outputDir ?? getDbSaicleGlobalPath();
