...
export class ProfileLifecycleManager {
  private savedConfigResult: ConfigResult<DbSaicleConfig> | undefined;
  private savedBrowserConfigResult?: ConfigResult<BrowserSerializedDbSaicleConfig>;
  private pendingConfigPromise?: Promise<ConfigResult<DbSaicleConfig>>;
  ...
  async loadConfig(
    ...
    this.pendingConfigPromise = new Promise((resolve) => {
      void (async () => {
        let result: ConfigResult<DbSaicleConfig>;
  ...
  async getSerializedConfig(
    additionalContextProviders: IContextProvider[],
  ): Promise<ConfigResult<BrowserSerializedDbSaicleConfig>> {
