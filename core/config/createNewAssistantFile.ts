...
# It is used to define custom AI agents within DbSaicle
# Each agent file can be accessed by selecting it from the agent dropdown

# To learn more, see the full config.yaml reference: https://docs.dbsaicle.dev/reference
...
# https://docs.dbsaicle.dev/customization/models
models:
  - name: my gpt-5
    provider: openai
    model: gpt-5
...
# https://docs.dbsaicle.dev/customization/mcp-tools
mcpServers:
