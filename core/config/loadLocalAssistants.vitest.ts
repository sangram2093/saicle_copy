...
import {
  getAllDotDbSaicleDefinitionFiles,
  LoadAssistantFilesOptions,
} from "./loadLocalAssistants";
describe("ASSISTANTS getAllDotDbSaicleDefinitionFiles with fileExtType option", () => {
  beforeEach(() => {
    setUpTestDir();
    ...
    addToTestDir([
      ".dbsaicle/assistants/",
      [".dbsaicle/assistants/assistant1.yaml", "yaml content 1"],
      [".dbsaicle/assistants/assistant2.yml", "yaml content 2"],
      [".dbsaicle/assistants/assistant3.md", "markdown content 1"],
      [".dbsaicle/assistants/assistant4.txt", "txt content"],
      [".dbsaicle/assistants/config.yaml", "txt content"],
      [".dbsaicle/assistants/config.yml", "txt content"],
    ]);
  });
  ...
  it("should return only YAML files when fileExtType is 'yaml'", async () => {
    ...
    const result = await getAllDotDbSaicleDefinitionFiles(
      testIde,
      options,
      "assistants",
    );
  ...
  it("should respect includeWorkspace option with fileExtType", async () => {
    ...
    const noWorkspaceResult = await getAllDotDbSaicleDefinitionFiles(
      testIde,
      workspaceOffOptions,
      "assistants",
    );
    ...
    const workspaceResult = await getAllDotDbSaicleDefinitionFiles(
      testIde,
      workspaceOnOptions,
      "assistants",
    );
  ...
  it("should return empty array when no files match the specified extension type", async () => {
    ...
    addToTestDir([
      ".dbsaicle/assistants/",
      [".dbsaicle/assistants/nonmatch1.txt", "txt content"],
      [".dbsaicle/assistants/nonmatch2.json", "json content"],
    ]);
  ...
  it("should filter by file extension case sensitively", async () => {
    ...
    addToTestDir([
      [".dbsaicle/assistants/assistant5.YAML", "uppercase yaml"],
      [".dbsaicle/assistants/assistant6.YML", "uppercase yml"],
      [".dbsaicle/assistants/assistant7.MD", "uppercase md"],
    ]);
    ...
    const yamlResult = await getAllDotDbSaicleDefinitionFiles(
      testIde,
      yamlOptions,
      "assistants",
    );
    ...
    const markdownResult = await getAllDotDbSaicleDefinitionFiles(
      testIde,
      markdownOptions,
      "assistants",
    );
...
describe("AGENTS getAllDotDbSaicleDefinitionFiles with fileExtType option", () => {
  beforeEach(() => {
    setUpTestDir();
    walkDirCache.invalidate();
    ...
    addToTestDir([
      ".dbsaicle/agents/",
      [".dbsaicle/agents/agent1.yaml", "yaml content 1"],
      [".dbsaicle/agents/agent2.yml", "yaml content 2"],
      [".dbsaicle/agents/agent3.md", "markdown content 1"],
      [".dbsaicle/agents/agent4.txt", "txt content"],
    ]);
  });
  ...
  it("should return empty array when no files match the specified extension type", async () => {
    ...
    addToTestDir([
      ".dbsaicle/agents/",
      [".dbsaicle/agents/nonmatch1.txt", "txt content"],
      [".dbsaicle/agents/nonmatch2.json", "json content"],
    ]);
  ...
  it("should filter by file extension case sensitively", async () => {
    // Add files with uppercase extensions
    addToTestDir([
      [".dbsaicle/agents/agent5.YAML", "uppercase yaml"],
      [".dbsaicle/agents/agent6.YML", "uppercase yml"],
      [".dbsaicle/agents/agent7.MD", "uppercase md"],
    ]);
