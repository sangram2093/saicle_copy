...
import { ModelConfig } from "@dbsaicledev/config-yaml";
import {
  DbSaicleConfig,
 ...
 *
 * See here for details: https://github.com/dbsaicledev/dbsaicle
 */
...
async function showUnsupportedCpuToast(ide: IDE) {
  ...
  if (shouldOpenLink) {
    void ide.openUrl(
      "https://docs.dbsaicle.dev/troubleshooting#i-received-a-codebase-indexing-disabled---your-linux-system-lacks-required-cpu-features-avx2-fma-notification",
    );
  }
}
