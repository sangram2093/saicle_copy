...
import { DbSaicleServerClient } from "../dbsaicleServer/stubs/client.js";
...
export class CodebaseIndexer {
  ...
  protected async getIndexesToBuild(): Promise<CodebaseIndex[]> {
    ...
    const dbsaicleServerClient = new DbSaicleServerClient(
      ideSettings.remoteConfigServerUrl,
      ideSettings.userToken,
    );
    if (!dbsaicleServerClient) {
      return [];
    }
  ...
  private isIndexingConfigSame(
    config1: DbSaicleConfig | undefined,
    config2: DbSaicleConfig,
  ) {
