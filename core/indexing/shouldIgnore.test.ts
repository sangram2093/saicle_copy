...
describe("shouldIgnore", () => {
  ...
  test("should return true if a folder is ignored by .dbsaicleignore", async () => {
    addToTestDir([
      ["ignored-folder/file.txt", "content"],
      [".dbsaicleignore", "ignored-folder/"],
    ]);
  ...
  test("should return true if a .dbsaicleignore override ignores file", async () => {
    addToTestDir([
      ["override-file.txt", "content"],
      [".gitignore", "override-file.txt"],
      [".dbsaicleignore", "!override-file.txt"],
    ]);
    const result = await shouldIgnore(
  ...
  test("should return true for deeply nested file ignored by ignore files at multiple levels", async () => {
    addToTestDir([
      ...
      ["level1/level2/.dbsaicleignore", "level3/"],
    ]);
    const result = await shouldIgnore(
