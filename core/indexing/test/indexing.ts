...
import { IDbSaicleServerClient } from "../../dbsaicleServer/interface";
...
export const testDbSaicleServerClient = {
  connected: false,
  getFromIndexCache: jest.fn(),
} as unknown as IDbSaicleServerClient;

const mockDbSaicleServerClient = {
  connected: false,
  getFromIndexCache: jest.fn(),
} as unknown as IDbSaicleServerClient;
