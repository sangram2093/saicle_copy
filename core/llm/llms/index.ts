...
import DbLLM from "./DbLLM";
import DbLLMRev1 from "./DbLLMRev1";
...
import DbSaicleProxy from "./stubs/DbSaicleProxy";
...
import VertexAIEnterpriseWIF from "./VertexAIEnterpriseWIF";
...
export async function llmFromDescription(
  ...
  if (desc.provider === "dbsaicle-proxy") {
