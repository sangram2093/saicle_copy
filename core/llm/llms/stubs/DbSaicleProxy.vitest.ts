...
import DbSaicleProxy from "./DbSaicleProxy.js";

vi.mock("@dbsaicledev/config-yaml", async (importOriginal) => {
...
describe("DbSaicleProxy", () => {
  afterEach(() => {
    vi.clearAllMocks();
  });

  test("rerank should send a valid request", async () => {
    const proxy = new DbSaicleProxy({
      apiKey: "test-api-key",
      model: "test-model",
      apiBase: "https://proxy.dbsaicle.dev/model-proxy/v1/",
    });
    ...
    await runLlmTest({
      ...
      expectedRequest: {
        url: "https://proxy.dbsaicle.dev/model-proxy/v1/rerank",
        method: "POST",
        headers: {
  ...
  test("streamChat should send a valid request", async () => {
    ...
    await runLlmTest({
      ...
      expectedRequest: {
        url: "https://proxy.dbsaicle.dev/model-proxy/v1/chat/completions",
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer test-api-key",
          "api-key": "test-api-key",
          "x-dbsaicle-unique-id": "NOT_UNIQUE",
        },
        body: {
          model: "test-model",
  ...
  test("streamFim should send a valid request", async () => {
    ...
    await runLlmTest({
      ...
      expectedRequest: {
        url: "https://proxy.dbsaicle.dev/model-proxy/v1/fim/completions",
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  test("embed should send a valid request", async () => {
    ...
    await runLlmTest({
      ...
      expectedRequest: {
        url: "https://proxy.dbsaicle.dev/model-proxy/v1/embeddings",
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer test-api-key",
  ...
  test("listModels should send a valid request", async () => {
    ...
    await runLlmTest({
      ...
      params: [],
      expectedRequest: {
        url: "https://proxy.dbsaicle.dev/model-proxy/v1/models",
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer test-api-key",
