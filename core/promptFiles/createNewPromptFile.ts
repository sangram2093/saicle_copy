...
# It is used to define and reuse prompts within DbSaicle
...
# To learn more, see the full .prompt file reference: https://docs.dbsaicle.dev/features/prompt-files
name: Example
