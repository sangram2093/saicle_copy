...
---
You are an expert development assistant. Your task is to create a comprehensive DBSAICLE.md project guide for the user's codebase to help them and their team better understand and work with the project.
...
- builtin_create_new_file: To generate the DBSAICLE.md file

If any of these tools are unavailable, inform the user that they need to activate them and enable "Agent Mode" in DbSaicle before proceeding.
...
## Step 3: Generate DBSAICLE.md
Create a comprehensive DBSAICLE.md file in the .dbsaicle/rules/ directory with the following sections:
...
## Step 4: Finalize
After creating the .dbsaicle/rules/DBSAICLE.md file, provide a summary of what you've created and remind the user to:
1. Review and edit the file as needed
2. Commit it to their repository to share with their team
3. Explain that DbSaicle will automatically load this file into context when working with the project
...
export const DEFAULT_PROMPTS_FOLDER_V2 = ".dbsaicle/prompts";
...
export async function getAllPromptFiles(
  ...
  // Also read from ~/.dbsaicle/.prompts
