...
export type ToWebviewFromIdeProtocol = ToWebviewFromIdeOrCoreProtocol & {
  ...
  focusDbSaicleInput: [undefined, void];
  focusDbSaicleInputWithoutClear: [undefined, void];
  focusDbSaicleInputWithNewSession: [undefined, void];
  ...
  focusDbSaicleSessionId: [{ sessionId: string | undefined }, void];
