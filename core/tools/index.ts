...
export const getBaseToolDefinitions = () => [
  ...
  toolDefinitions.extractEntitiesTool,
  ...
  toolDefinitions.servicenowCreateIncidentTool,
  toolDefinitions.servicenowUpdateIncidentTool,
  toolDefinitions.servicenowAddCommentTool,
  toolDefinitions.servicenowResolveIncidentTool,
  toolDefinitions.servicenowListIncidentsTool,
  toolDefinitions.servicenowGetIncidentTool,
  toolDefinitions.servicenowListKbArticlesTool,
  toolDefinitions.servicenowGetKbArticleTool,
  toolDefinitions.servicenowListKbBasesTool,
  toolDefinitions.servicenowListKbCategoriesTool,
  toolDefinitions.servicenowListKbTopicsTool,
  toolDefinitions.servicenowListCatalogItemsTool,
  toolDefinitions.servicenowGetCatalogItemTool,
  toolDefinitions.servicenowListCatalogCategoriesTool,
  toolDefinitions.servicenowCreateCatalogCategoryTool,
  toolDefinitions.servicenowUpdateCatalogCategoryTool,
  toolDefinitions.servicenowMoveCatalogItemsTool,
  toolDefinitions.servicenowCreateCatalogItemVariableTool,
  toolDefinitions.servicenowListCatalogItemVariablesTool,
  toolDefinitions.servicenowUpdateCatalogItemVariableTool,
  toolDefinitions.servicenowListCatalogsTool,
  toolDefinitions.servicenowCreateChangeRequestTool,
  toolDefinitions.servicenowUpdateChangeRequestTool,
  toolDefinitions.servicenowListChangeRequestsTool,
  toolDefinitions.servicenowGetChangeRequestDetailsTool,
  toolDefinitions.servicenowAddChangeTaskTool,
  toolDefinitions.servicenowSubmitChangeForApprovalTool,
  toolDefinitions.servicenowApproveChangeTool,
  toolDefinitions.servicenowRejectChangeTool,
  toolDefinitions.servicenowCreateTaskTool,
  toolDefinitions.servicenowUpdateTaskTool,
  toolDefinitions.servicenowGetTaskTool,
  toolDefinitions.servicenowListTasksTool,
  toolDefinitions.servicenowCreateProblemTaskTool,
  toolDefinitions.servicenowUpdateProblemTaskTool,
  toolDefinitions.servicenowGetProblemTaskTool,
  toolDefinitions.servicenowListProblemTasksTool,
  toolDefinitions.servicenowCreateScTaskTool,
  toolDefinitions.servicenowUpdateScTaskTool,
  toolDefinitions.servicenowGetScTaskTool,
  toolDefinitions.servicenowListScTasksTool,
];
