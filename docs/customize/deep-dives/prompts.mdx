---
title: "Creating Custom Prompts in DbSaicle"
description: "Learn how to create reusable prompt files in DbSaicle to streamline repetitive tasks, including examples for code reviews, security checks, and entity generation"
---
...
Below are more examples to get you started. You can also visit the Hub to [explore prompts](https://hub.dbsaicle.dev/explore/prompts) or [create your own](https://hub.dbsaicle.dev/new?type=block&blockType=prompts).
