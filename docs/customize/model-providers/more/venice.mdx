---
title: "Venice AI"
description: "Configure Venice AI with DbSaicle to access this privacy-focused generative AI platform that supports open-source LLMs without storing private user data"
---
...
Change `~/.dbsaicle/config.json` to look like the following.
