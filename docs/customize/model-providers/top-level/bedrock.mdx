---
title: "How to Configure Amazon Bedrock with DbSaicle"
slug: ../bedrock
sidebarTitle: "Amazon Bedrock"
---

<Tip>
  **Discover Amazon Bedrock models [here](https://hub.dbsaicle.dev/amazon)**
</Tip>
...
<Info>
  **Check out a more advanced configuration [here](https://hub.dbsaicle.dev/amazon/us-anthropic-claude-sonnet-4-20250514-v1?view=config)**
</Info>
