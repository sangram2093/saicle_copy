---
title: "How to Configure Ollama with DbSaicle"
slug: ../ollama
sidebarTitle: "Ollama"
---

<Tip>
  **Discover Ollama models [here](https://hub.dbsaicle.dev/lmstudio)**
</Tip>
...
<Info>
  **Check out a more advanced configuration [here](https://hub.dbsaicle.dev/ollama/qwen3-coder-30b?view=config)**
</Info>
