---
title: "How to Configure OpenAI Models with DbSaicle"
slug: ../openai
sidebarTitle: "OpenAI"
---

<Tip>
  **Discover OpenAI models [here](https://hub.dbsaicle.dev/openai)**
</Tip>
...
<Info>
  **Check out a more advanced configuration [here](https://hub.dbsaicle.dev/openai/gpt-5?view=config)**
</Info>
