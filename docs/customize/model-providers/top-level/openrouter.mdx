---
title: "How to Configure OpenRouter with DbSaicle"
sidebarTitle: "OpenRouter"
---

<Tip>
  **Discover Inception models [here](https://hub.dbsaicle.dev/inceptionlabs)**
</Tip>
...
<Info>
  **Check out a more advanced configuration [here](https://hub.dbsaicle.dev/openrouter/qwen3-coder?view=config)**
</Info>
...
<Info>
  DbSaicle automatically uses system message tools for models that don't support
