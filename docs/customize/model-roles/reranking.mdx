...
In DbSaicle, rerankers are designated using the `rerank` role and used by [@Codebase](../context/codebase) in order to select the most relevant code snippets after vector search.
...
<Tabs>
  <Tab title="Hub">
  [Voyage Rerank 2 Block](https://hub.dbsaicle.dev/voyageai/rerank-2)
  </Tab>
  <Tab title="YAML">
...
<Tabs>
  ...
  {/* <Tab title="Hub">
  [Cohere Reranker English v3](https://hub.dbsaicle.dev/)
  </Tab> */}
  <Tab title="YAML">
  ```yaml title="config.yaml"
  models:
...
<Tabs>
  {/* HUB_TODO block doesn't exist */}
  {/* <Tab title="Hub">
  [GPT-4o LLM Reranker Block](https://hub.dbsaicle.dev/)
  </Tab> */}
  <Tab title="YAML">
  ```yaml title="config.yaml"
  models:
...
<Tabs>
  {/* HUB_TODO */}
  {/* <Tab title="Hub">
  [HuggingFace TEI Reranker block](https://hub.dbsaicle.dev/)
  </Tab> */}
    <Tab title="YAML">
    ```yaml title="config.yaml"
    models:
