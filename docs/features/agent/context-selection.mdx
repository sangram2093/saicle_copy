...
description: "Learn how DbSaicle's agent mode selects relevant code context using file content, language server definitions, imports, and recent file history."
---
