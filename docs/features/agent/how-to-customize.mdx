...
description: "Learn how to customize Agent Mode in DbSaicle to better fit your workflow and coding style."
sidebarTitle: "Customize Agent"
---

## How to Add Rules Blocks

Adding Rules can be done in your agent locally or in the Hub. You can explore Rules on the DbSaicle Hub and refer to the [Rules deep dive](/customize/deep-dives/rules) for more details.
...
You can add MCP servers to your agent to give Agent access to more tools. Explore [MCP Servers on the Hub](https://hub.dbsaicle.dev) and consult the [MCP guide](/customize/deep-dives/mcp) for more details.

## How to Configure Tool Policies

You can adjust the Agent's tool usage behavior to three options:

- **Ask First (default)**: Request user permission with "Cancel" and "DbSaicle" buttons
