---
title: "Recommended Models for Autocomplete in DbSaicle"
description: "Choose the best autocomplete model for DbSaicle, including hosted high-performance options, fast speed/quality tradeoffs, and local privacy-first models."
...
For proactive code prediction that anticipates your next edit, DbSaicle supports specialized [Next Edit](/features/autocomplete/next-edit) models:
