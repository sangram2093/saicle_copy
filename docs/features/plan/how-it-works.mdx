...
1. DbSaicle sends a special system message instructing the model to focus on understanding and planning
...
<Info>
  ...
  are not filtered by DbSaicle. Some MCP tools may have write capabilities that
...
<Info>
  ...
  the
  code](https://github.com/dbsaicledev/continue/blob/main/core/llm/defaultSystemMessages.ts).
</Info>
