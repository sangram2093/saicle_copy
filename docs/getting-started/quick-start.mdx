...
description: "Learn DbSaicle's core features through hands-on exercises. Get started with Autocomplete, Edit, Chat, and Agent in minutes."
sidebarTitle: "Quick Start"
---

Welcome to DbSaicle! This interactive tutorial will guide you through all four core features using practical examples. Follow along step-by-step to learn more about DbSaicle's capabilities.

<Info>
  **Prerequisites**: Make sure you have [installed
  DbSaicle](/getting-started/install) and [signed
  in](https://auth.dbsaicle.dev/) to get started.
</Info>
...
Press **Enter** and watch DbSaicle suggest code completions. Press **Tab** to accept suggestions.

</Step>

<Step title="See the Magic">
DbSaicle will intelligently suggest function implementations based on the context and comment.
</Step>
</Steps>
...
<Step title="Watch the Magic">
  Watch DbSaicle refactor your code automatically!
</Step>

<Step title="Review Changes">
DbSaicle will show you a diff of the proposed changes. Accept or reject individual changes as needed.
</Step>
</Steps>
...
Congratulations! You've experienced all four core DbSaicle features. Here's what to explore next:
...
<CardGroup cols={2}>
  ...
  >
    Get help and share experiences with other DbSaicle users
  </Card>
</CardGroup>
...
<Info>
  **Need help?** Check our [troubleshooting guide](/troubleshooting) or ask a
  ...
  discussions](https://github.com/dbsaicledev/continue/discussions).
</Info>
