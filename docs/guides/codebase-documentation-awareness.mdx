...
Rules guide your agent's behavior and understanding. Place markdown files in `.dbsaicle/rules` in your project to provide context:
...
[DeepWiki MCP](https://hub.dbsaicle.dev/deepwiki/deepwiki-mcp) lets your agent explore any public GitHub repository.
...
[Context7 MCP](https://hub.dbsaicle.dev/upstash/context7-mcp) enables your agent to search and retrieve information from public documentation:
...
2. **Add rules**: Create `.dbsaicle/rules` files to provide context about your project structure
...
The new approach provides better integration with DbSaicle's Agent features and more intelligent context selection.

## Next steps

- Learn more about [MCP servers](/reference/dbsaicle-mcp)
