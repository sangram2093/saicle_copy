...
Think of it this way: DevOps automated the mechanical aspects of software deliveryâ€”building, testing, deploying. Continuous AI automates the intelligence aspectsâ€”understanding context, making suggestions, adapting to patterns, and learning from developer feedback.
...
**DbSaicle Implementation**: Using [Chat](/features/chat/quick-start) or [Edit](/features/edit/quick-start) mode for one-off coding tasks.
...
**DbSaicle Implementation**: Using [DbSaicle CLI](/guides/cli) with custom rules and integrations into CI/CD pipelines.
...
**DbSaicle Implementation**: Fully automated [agents](/features/agent/quick-start) with strict permissions and safety guardrails.

</Accordion>

## Building Your Continuous AI Workflow

### Start with Level 1 â†’ Level 2: Pick One Workflow
...
Use DbSaicle CLI's permission system to gradually expand AI capabilities:

```yaml ~/.dbsaicle/permissions.yaml
permissions:
...
<Steps>
  <Step title="Install DbSaicle CLI">
    ```bash npm i -g @dbsaicledev/cli ```
  </Step>
...
<Card title="Want to dive deeper?" icon="rocket">
  Check out our guides on [DbSaicle CLI](/guides/cli) and [Understanding
  Agents](/guides/understanding-agents).
</Card>
