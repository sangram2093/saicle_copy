...
The `config.yaml` is parsed by the open-source DbSaicle IDE extensions to create custom agent experiences. When you log in to [hub.dbsaicle.dev](https://hub.dbsaicle.dev/), your agents will automatically be synced with the IDE extensions.
