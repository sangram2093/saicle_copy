...
This is a CLI tool for DbSaicle Dev that provides an interactive AI-assisted development experience. The architecture consists of:
...
3. **DbSaicle SDK Integration** (`src/dbsaicleSDK.ts`): Initializes the DbSaicle SDK client with:
