...
The DbSaicle CLI (`cn`) is a customizable command line coding agent.

![DbSaicle CLI Demo](./media/demo.gif)

## Installation

```bash
npm i -g @dbsaicledev/cli
```
...
- `cn login`: Authenticate with DbSaicle
