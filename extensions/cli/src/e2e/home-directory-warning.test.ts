    ...
    it("should NOT show warning in headless mode even when running from home directory", async () => {
      ...
      const result = await runCLI(context, {
        ...
        env: {
          ...
          DBSAICLE_GLOBAL_DIR: path.join(context.testDir, ".dbsaicle-global"),
        },
        timeout: 5000,
        expectError: true,
      });
    ...
    it("should NOT show warning in headless mode with symlinked home directories", async () => {
      ...
      const result = await runCLI(context, {
        ...
        env: {
          ...
          DBSAICLE_GLOBAL_DIR: path.join(realHome, ".dbsaicle-global"),
        },
        timeout: 5000,
        expectError: true,
      });
