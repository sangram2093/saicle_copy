...
export async function handleMaxedOutFreeTrial(
  ...
  console.log("Choose how you'd like to DbSaicle:");
  ...
  if (choice === "1" || choice === "") {
    ...
    try {
      ...
      console.log(
        chalk.dim(
          "After setting up your models subscription, restart the CLI to dbsaicle.",
        ),
      );
    } catch {
  ...
  console.log(
    chalk.green(
      "\n🔄 Restarting DbSaicle CLI to resume your conversation...\n",
    ),
  );
