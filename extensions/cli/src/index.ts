...
program
  .name("cn")
  .description(
    "DbSaicle CLI - AI-powered development assistant. Starts an interactive session by default, use -p/--print for non-interactive output.",
  )
...
program
  .command("login")
  .description("Authenticate with DbSaicle")
  .action(async () => {
    // Telemetry: record command invocation
...
program
  .command("logout")
  .description("Log out from DbSaicle")
  .action(async () => {
    // Telemetry: record command invocation
