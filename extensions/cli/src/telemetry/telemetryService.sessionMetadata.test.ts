...
describe("TelemetryService - Session Metadata", () => {
  ...
  beforeEach(() => {
    ...
    process.env.DBSAICLE_CLI_ENABLE_TELEMETRY = "1";
  ...
  describe("recordSessionStart", () => {
    ...
    it("should include is_github_actions=false when not in GitHub Actions", () => {
      ...
      expect(mockAdd).toHaveBeenCalledWith(
        ...
        expect.objectContaining({
          ...
          is_dbsaicle_remote_agent: "false",
        }),
      );
    });
    ...
    it("should include is_dbsaicle_remote_agent=true when in remote agent mode", () => {
      // Set DbSaicle remote agent environment
      process.env.DBSAICLE_REMOTE = "true";
