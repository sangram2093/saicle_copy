  ...
  const handleOptionSelect = async () => {
    if (selectedOption === 1) {
      ...
      try {
        ...
        setSuccessMessage(
          `Browser opened to ${modelsUrl}. After setting up your models subscription, press Enter to dbsaicle.`,
        );
        setCurrentStep("success");
      } catch {
        setErrorMessage(
          `Could not open browser automatically. Please visit: ${modelsUrl}. After setting up your models subscription, press Enter to dbsaicle.`,
        );
