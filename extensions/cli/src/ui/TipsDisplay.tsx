...
// Array of helpful tips for DbSaicle CLI users
const DBSAICLE_CLI_TIPS = [
  "Use `/help` to learn keyboard shortcuts",
  "Press escape to pause cn, and press enter to continue",
  "Use arrow keys (â†‘/â†“) to navigate through your input history",
...
/**
 * Randomly selects and displays a tip from the DBSAICLE_CLI_TIPS array.
...
const TipsDisplay: React.FC<TipsDisplayProps> = () => {
  ...
  const randomTip = useMemo(
    () =>
      DBSAICLE_CLI_TIPS[Math.floor(Math.random() * DBSAICLE_CLI_TIPS.length)],
    [],
  );
...
export { DBSAICLE_CLI_TIPS, TipsDisplay };
