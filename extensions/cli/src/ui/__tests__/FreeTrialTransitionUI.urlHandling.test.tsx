...
describe("FreeTrialTransitionUI - URL Opening Security", () => {
  ...
  it("should verify URL format for models setup", () => {
    ...
    const baseUrl = "https://test.dbsaicle.dev";
    const expectedUrl = new URL("setup-models", baseUrl).toString();

    expect(expectedUrl).toBe("https://test.dbsaicle.dev/setup-models");
  });
  ...
  it("should handle URL construction with different base URLs", () => {
    ...
    const testCases = [
      {
        base: "https://dbsaicle.dev",
        expected: "https://dbsaicle.dev/setup-models",
      },
      {
        base: "https://app.dbsaicle.dev",
        expected: "https://app.dbsaicle.dev/setup-models",
      },
      {
