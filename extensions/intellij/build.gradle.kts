...
intellijPlatformTesting {
    runIde {
        // This task might not work locally because the binary tends to ignore DBSAICLE_GLOBAL_DIR when a
        // local DbSaicle config is present. If you want to run the e2e tests locally, the most effective
        ...
        register("runIdeForUiTests") {
            task {
                environment(
                    "DBSAICLE_GLOBAL_DIR",
                    "${rootProject.projectDir}/src/test/kotlin/com/github/dbsaicledev/dbsaicleintellijextension/e2e/test-dbsaicle"
                )
