...
import com.github.dbsaicledev.dbsaicleintellijextension.ApplyState
import com.github.dbsaicledev.dbsaicleintellijextension.ApplyStateStatus
import com.github.dbsaicledev.dbsaicleintellijextension.IDE
import com.github.dbsaicledev.dbsaicleintellijextension.ToastType
import com.github.dbsaicledev.dbsaicleintellijextension.browser.DbSaicleBrowserService.Companion.getBrowser
import com.github.dbsaicledev.dbsaicleintellijextension.editor.DiffStreamHandler
...
import com.github.dbsaicledev.dbsaicleintellijextension.protocol.ApplyToFileParams
...
class ApplyToFileHandler(
    ...
    companion object {
         ...
         */
        suspend fun apply(
            project: Project, dbsaiclePluginService: DbSaiclePluginService, ide: IDE, params: ApplyToFileParams
        ) {
            val editorUtils =
            ...
            val handler = ApplyToFileHandler(
                project, dbsaiclePluginService, ide, params, editorUtils, diffStreamService
            )
