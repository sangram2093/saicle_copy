...
import com.github.dbsaicledev.dbsaicleintellijextension.activities.DbSaiclePluginDisposable
import com.github.dbsaicledev.dbsaicleintellijextension.activities.showTutorial
...
import com.github.dbsaicledev.dbsaicleintellijextension.protocol.*
...
import com.github.dbsaicledev.dbsaicleintellijextension.utils.getMachineUniqueID
import com.github.dbsaicledev.dbsaicleintellijextension.utils.uuid
...
class IdeProtocolClient(
    ...
    private val ide: IDE = IntelliJIDE(project, dbsaiclePluginService)
     ...
     *
     * See this thread for details: https://github.com/dbsaicledev/continue/issues/4098#issuecomment-2854865310
     */
    ...
    fun handleMessage(msg: String, respond: (Any?) -> Unit) {
        coroutineScope.launch(limitedDispatcher) {
            ...
            try {
                when (messageType) {
                    ...
                    "jetbrains/onLoad" -> {
                        val jsonData = mutableMapOf(
                            "windowId" to dbsaiclePluginService.windowId,
                            "workspacePaths" to dbsaiclePluginService.workspacePaths,
                    ...
                    "closeSidebar" -> {
                        ApplicationManager.getApplication().invokeLater {
                            ...
                            val toolWindow = toolWindowManager.getToolWindow("DbSaicle")
                            toolWindow?.hide()
                        }
                    }
                ...
                service<DbSaicleSentryService>().report(exception, exceptionMessage)
