...
import com.github.dbsaicledev.dbsaicleintellijextension.*
...
import com.github.dbsaicledev.dbsaicleintellijextension.dbsaicle.file.FileUtils
...
import com.github.dbsaicledev.dbsaicleintellijextension.utils.*
...
class IntelliJIDE(
    ...
    private val gitService = GitService(project, dbsaiclePluginService)
    ...
    override suspend fun getIdeInfo(): IdeInfo {
        ...
        val pluginId = DbSaicleConstants.PLUGIN_ID
    ...
    suspend fun enableHubDbSaicleDev(): Boolean {
        return true
    }
    ...
    override suspend fun getIdeSettings(): IdeSettings {
        ...
        return IdeSettings(
            remoteConfigServerUrl = settings.dbsaicleState.remoteConfigServerUrl,
            remoteConfigSyncPeriod = settings.dbsaicleState.remoteConfigSyncPeriod,
            userToken = settings.dbsaicleState.userToken ?: "",
            dbsaicleTestEnvironment = "production",
    ...
    override suspend fun getDbSaicleDir(): String {
        return getDbSaicleGlobalPath()
    }
    ...
    override suspend fun showDiff(filepath: String, newContents: String, stepIndex: Int) {
        dbsaiclePluginService.diffManager?.showDiff(filepath, newContents, stepIndex)
    }
    ...
    override suspend fun getFileResults(pattern: String, maxResults: Int?): List<String> {
        ...
        if (ideInfo.remoteName == "local") {
            try {
                ...
                service<DbSaicleSentryService>().report(exception, message)
    ...
    override suspend fun showToast(type: ToastType, message: String, vararg otherParams: Any): Any {
        return withContext(Dispatchers.Default) {
            ...
            val notification = NotificationGroupManager.getInstance().getNotificationGroup("DbSaicle")
                .createNotification(message, notificationType).setIcon(Icons.DbSaicle)
