...
import com.github.dbsaicledev.dbsaicleintellijextension.StreamDiffLinesPayload
...
class DiffStreamHandler(
    ...
    private fun initUnfinishedRangeHighlights() {
        ...
        val unfinishedKey = editorUtils.createTextAttributesKey("DBSAICLE_DIFF_UNFINISHED_LINE", 0x20888888)
    ...
    private fun updateProgressHighlighters(type: DiffLineType) {
        val editorUtils = EditorUtils(editor)
        val curLineKey = editorUtils.createTextAttributesKey("DBSAICLE_DIFF_CURRENT_LINE", 0x40888888)
