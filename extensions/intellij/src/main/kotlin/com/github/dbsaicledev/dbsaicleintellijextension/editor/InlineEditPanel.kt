package com.github.dbsaicledev.dbsaicleintellijextension.editor

import com.github.dbsaicledev.dbsaicleintellijextension.Icons
import com.github.dbsaicledev.dbsaicleintellijextension.dbsaicle.GetTheme
...
import com.github.dbsaicledev.dbsaicleintellijextension.utils.getMetaKeyLabel
import com.github.dbsaicledev.dbsaicleintellijextension.utils.getShiftKeyLabel
...
class CustomPanel(
    ...
    private val subPanelA: JPanel =
        JPanel(MigLayout("insets 0, fillx")).apply {
            val globalScheme = EditorColorsManager.getInstance().globalScheme
            val defaultBackground = globalScheme.defaultBackground
            val dbsaicleSettingsService = service<DbSaicleExtensionSettings>()
            val dropdown =
                JComboBox(modelTitles.toTypedArray()).apply {
                    ...
                    selectedIndex =
                        if (itemCount == 0) -1 else dbsaicleSettingsService.dbsaicleState.lastSelectedInlineEditModel?.let {
                    ...
                    addActionListener {
                        dbsaicleSettingsService.dbsaicleState.lastSelectedInlineEditModel =
