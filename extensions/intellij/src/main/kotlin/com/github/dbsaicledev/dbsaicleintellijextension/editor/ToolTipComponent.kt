import com.github.dbsaicledev.dbsaicleintellijextension.actions.FocusDbSaicleInputAction
import com.github.dbsaicledev.dbsaicleintellijextension.editor.openInlineEdit
...
class ToolTipComponent(editor: Editor, x: Int, y: Int) :
    ...
    init {
        ...
        addToChatButton.addActionListener { e: ActionEvent? ->
            FocusDbSaicleInputAction.focusDbSaicleInput(editor.project)
