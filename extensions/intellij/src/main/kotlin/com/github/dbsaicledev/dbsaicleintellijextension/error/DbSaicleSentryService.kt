...
@Service
class DbSaicleSentryService(
    private val telemetryStatus: DbSaicleTelemetryStatus = service<DbSaicleTelemetryStatusService>()
) {
    private val log = Logger.getInstance(DbSaicleSentryService::class.java.simpleName)
    ...
    private companion object {
        private const val PLUGIN_ID = "com.github.dbsaicledev.dbsaicleintellijextension"
