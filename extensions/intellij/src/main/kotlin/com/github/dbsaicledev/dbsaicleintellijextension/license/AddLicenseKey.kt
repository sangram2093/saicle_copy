package com.github.dbsaicledev.dbsaicleintellijextension.license
...
class AddLicenseKey : AnAction() {
    ...
    private fun performAddLicenseKey(project: Project?) {
        ...
        if (dialog.exitCode != DialogWrapper.OK_EXIT_CODE)
            return
        val messenger = project.service<DbSaiclePluginService>().coreMessenger
            ?: return
    ...
    private fun createSuccessAction() =
        getDbSaicleNotifications().createNotification(
    ...
    private fun getDbSaicleNotifications() =
        NotificationGroupManager.getInstance().getNotificationGroup("DbSaicle")
}