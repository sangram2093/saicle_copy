...
import com.github.dbsaicledev.dbsaicleintellijextension.utils.Debouncer
...
class DbSaiclePluginSelectionListener(
    ...
    private fun shouldRemoveTooltip(selectedText: String?, editor: Editor): Boolean {
        return selectedText.isNullOrEmpty() ||
                !service<DbSaicleExtensionSettings>().dbsaicleState.displayEditorTooltip
    }
