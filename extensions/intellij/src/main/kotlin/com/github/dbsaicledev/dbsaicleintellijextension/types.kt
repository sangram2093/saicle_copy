package com.github.dbsaicledev.dbsaicleintellijextension

import com.github.dbsaicledev.dbsaicleintellijextension.editor.RangeInFileWithContents
...
data class IdeSettings(
    ...
    val dbsaicleTestEnvironment: String
)
...
interface IDE {
    ...
    suspend fun getDbSaicleDir(): String
...
data class HighlightedCodePayload(
    val rangeInFileWithContents: com.github.dbsaicledev.dbsaicleintellijextension.RangeInFileWithContents,
