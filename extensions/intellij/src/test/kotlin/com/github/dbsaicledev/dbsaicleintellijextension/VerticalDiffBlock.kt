...
import com.github.dbsaicledev.dbsaicleintellijextension.editor.VerticalDiffBlock
...
class VerticalDiffBlockTest : BasePlatformTestCase() {
    ...
    fun testAddNewLine() {
        ...
        val expectedTextAttributesKey = TextAttributesKey.find("DBSAICLE_DIFF_NEW_LINE")
