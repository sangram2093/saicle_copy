...
import com.github.dbsaicledev.dbsaicleintellijextension.fixtures.*
...
import com.github.dbsaicledev.dbsaicleintellijextension.utils.getMetaKey
...
class GUI {
    ...
    fun highlightCode(remoteRobot: RemoteRobot): Unit = with(remoteRobot) {
        ...
        // while the `dbsaicle_tutorial.java` is loading.
