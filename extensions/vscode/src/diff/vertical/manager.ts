...
export class VerticalDiffManager {
  ...
  async streamDiffLines(
    ...
    vscode.commands.executeCommand("setContext", "dbsaicle.diffVisible", true);
  ...
  async streamEdit({
    ...
    if (existingHandler) {
      ...
      // but extra delta was added for each line generated by DbSaicle
      // Before adding this back, we need to distinguish between human and DbSaicle
    ...
    try {
      ...
      if (abortController.signal.aborted) {
        void vscode.commands.executeCommand("dbsaicle.rejectDiff");
      }
