import { DbSaicleConfig } from "core";
 ...
 *
 * @param config - The DbSaicle configuration object
...
/**
 * Registers all CodeLens providers for the DbSaicle extension.
 *
...
export function registerAllCodeLensProviders(
  ...
  config: DbSaicleConfig | undefined,
) {
