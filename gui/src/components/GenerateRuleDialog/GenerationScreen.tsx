...
export function GenerationScreen({
  ...
  const handleDbSaicle = async () => {
    ...
    try {
      ...
      const localDbSaicleDir = workspaceDirs.content[0];
      const ruleFilePath = createRuleFilePath(localDbSaicleDir, formData.name);
