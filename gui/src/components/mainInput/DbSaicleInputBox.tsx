...
interface DbSaicleInputBoxProps {
...
function DbSaicleInputBox(props: DbSaicleInputBoxProps) {
  ...
  return (
    <div
      ...
      data-testid={`dbsaicle-input-box-${props.inputId}`}
    >
...
export default DbSaicleInputBox;
