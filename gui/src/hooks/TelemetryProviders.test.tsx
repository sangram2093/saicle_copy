...
vi.mock("../context/Auth", () => ({
  ...
  useAuth: () => ({
    session: {
      account: {
        id: "test@dbsaicle.dev", // Mock DbSaicle team member email
      },
    },
  }),
}));

// Mock isDbSaicleTeamMember utility
vi.mock("../util/isDbSaicleTeamMember", () => ({
  isDbSaicleTeamMember: vi.fn(() => true), // Mock as DbSaicle team member
}));
