...
export const models: { [key: string]: ModelPackage } = {
  ...
  VertexGemini20Flash: {
    title: "Gemini 2.0 Flash",
    description: "A newer Gemini model with 2M token context length",
    params: {
      title: "Gemini 2.0 Flash",
  ...
  dbllm: {
    ...
    icon: "gemini.png",
    providerOptions: ["dbllm"],
    isOpenSource: false,
  },
  dbllmrev1: {
    title: "DB LLM Rev1",
    description: "Deutsche Bank LLM for Rev1 Use cases.",
    params: {
      title: "DBLLMRev1",
      model: "gemini-2.5-pro",
      contextLength: 2_097_152,
