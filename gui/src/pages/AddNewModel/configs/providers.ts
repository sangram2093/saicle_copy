...
export const providers: Partial<Record<string, ProviderInfo>> = {
  ...
  moonshot: {
    ...
    longDescription: `[Visit our documentation](https://docs.dbsaicle.dev/reference/Model%20Providers/moonshot) for information on obtaining an API key.`,
    icon: "moonshot.png",
    tags: [ModelProviderTags.RequiresApiKey],
    refPage: "moonshot",
  ...
  azure: {
    ...
    longDescription: `[Visit our documentation](https://docs.dbsaicle.dev/reference/Model%20Providers/azure) for information on obtaining an API key.
...
Select the \`GPT-4o\` model below to complete your provider configuration, but note that this will not affect the specific model you need to select when creating your Azure deployment.`,
  ...
  novita: {
    ...
    icon: "novita.png",
    longDescription: `[Novita AI](https://novita.ai?utm_source=github_dbsaicledev&utm_medium=github_readme&utm_campaign=github_link) offers an affordable, reliable, and simple inference platform with scalable [LLM APIs](https://novita.ai/docs/model-api/reference/introduction.html), empowering developers to build AI applications. To get started with Novita AI:\n1. Obtain an API key from [here](https://novita.ai/settings/key-management?utm_source=github_dbsaicledev&utm_medium=github_readme&utm_campaign=github_link)\n2. Paste below\n3. Select a model preset`,
    tags: [ModelProviderTags.RequiresApiKey, ModelProviderTags.OpenSource],
    params: {
      apiKey: "",
    },
    ...
    apiKeyUrl:
      "https://novita.ai/settings/key-management?utm_source=github_dbsaicledev&utm_medium=github_readme&utm_campaign=github_link",
  },
  gemini: {
...
After it's up and running, you can start using DbSaicle.`,
    icon: "llamacpp.png",
    tags: [ModelProviderTags.Local, ModelProviderTags.OpenSource],
    packages: openSourceModels,
    collectInputFor: [...completionParamsInputsConfigs],
...
- [llama-cpp-python](https://github.com/dbsaicledev/ggml-server-example)
...
To get started, [register](https://dataplatform.cloud.ibm.com/registration/stepone?context=wx) on watsonx SaaS, create your first project and setup an [API key](https://www.ibm.com/docs/en/mas-cd/continuous-delivery?topic=cli-creating-your-cloud-api-key).`,
  ...
  dbllm: {
    title: "DB LLM",
    provider: "dbllm",
    description: "Use db llm",
    longDescription: "Use Deutsche Bank Internal LLM",
    icon: "vertexai.png",
    packages: [models.dbllm],
    collectInputFor: [
      {
        inputType: "email",
        key: "email",
        label: "User Email",
        placeholder:
          "Enter your Deutsche Bank email address for which the DBLLM key is valid.",
        required: true,
      },
      {
        inputType: "kannon_id",
        key: "kannon_id",
        label: "Kannon ID",
        placeholder: "Enter Kannon ID for which the DBLLM key is valid.",
        required: true,
      },
      {
        inputType: "text",
        key: "dbllm_apikey",
        label: "DBLLM API Key",
        placeholder: "Enter your DBLLM API Key",
        required: true,
      },
      {
        inputType: "data_classification",
        key: "data_classification",
        label: "Data Classification",
        placeholder:
          "Enter your data classification (e.g. For Internal Use Only, Confidential, Public, External Communication etc.)",
        required: true,
      },
      ...completionParamsInputsConfigs,
    ],
  ...
  DbLLMRev1: {
    title: "DB LLM Rev1",
    provider: "dbllmrev1",
    description: "Use db llm for Rev1 use cases",
    longDescription:
      "Use Deutsche Bank Internal LLM for Rev1 use cases involving internal used only Data.",
    icon: "vertexai.png",
    packages: [models.dbllmrev1],
    collectInputFor: [
      {
        inputType: "email",
        key: "email",
      ...
      {
        inputType: "text",
        key: "dbllm_urlendpoint",
        label: "DBLLM URL Endpoint",
        placeholder: "Enter your DBLLM URL Endpoint",
        required: false,
      },
      {
        inputType: "data_classification",
        ...
        label: "Data Classification",
        placeholder:
          "Enter your data classification (e.g. For Internal Use Only, Public.)",
        required: true,
      },
      ...completionParamsInputsConfigs,
    ],
  ...
  vertexai_enterprise_wif: {
    title: "VertexAI Enterprise (WIF)",
    provider: "vertexai_enterprise_wif",
    description:
      "Use supported Vertex AI models authenticated with Workload Identity Federation",
    longDescription:
    ...
    collectInputFor: [
      ...
      },
      {
        ...
        key: "wif_json_path",
        label: "WIF JSON Path",
        placeholder: "Enter your Vertex AI WIF JSON path",
        required: true,
      },
