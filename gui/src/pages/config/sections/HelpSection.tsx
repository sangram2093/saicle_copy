...
const vscodeShortcuts: Omit<KeyboardShortcutProps, "isEven">[] = [
  ...
  },
  {
    shortcut: "cmd L",
    description:
      "New Chat / New Chat With Selected Code / Close DbSaicle Sidebar If Chat Already In Focus",
  },
  {
  ...
  },
  {
    ...
    description:
      "Focus Current Chat / Add Selected Code To Current Chat / Close DbSaicle Sidebar If Chat Already In Focus",
  },
  {
        ...
        <div>
          ...
          <Card className="!p-0">
            <div className="flex flex-col">
              <ConfigRow
                title="DbSaicle Hub"
                description="Visit hub.dbsaicle.dev to explore custom agents and blocks"
                icon={LinkIcon}
                onClick={() =>
                  ideMessenger.post("openUrl", "https://hub.dbsaicle.dev/")
                }
              />

              <ConfigRow
                title="Documentation"
                description="Learn how to configure and use DbSaicle"
                icon={LinkIcon}
                onClick={() =>
                  ideMessenger.post("openUrl", "https://docs.dbsaicle.dev/")
                }
              />
              ...
              <ConfigRow
                ...
                onClick={() =>
                  ideMessenger.post(
                    "openUrl",
                    "https://github.com/dbsaicledev/continue/issues/new/choose",
                  )
                }
              />
