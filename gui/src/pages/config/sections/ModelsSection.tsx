        ...
        <ModelRoleRow
          ...
          description={
            <span>
              ...
              <a
                href="https://docs.dbsaicle.dev/features/chat/quick-start hover:text-inherit"
                target="_blank"
          ...
          setupURL="https://docs.dbsaicle.dev/chat/model-setup"
        />
        ...
        <ModelRoleRow
          ...
          description={
            <span>
              ...
              <a
                href="https://docs.dbsaicle.dev/features/autocomplete/quick-start"
                target="_blank"
                rel="noopener noreferrer"
                className="text-inherit underline hover:brightness-125"
              >
          ...
          onConfigure={handleConfigureModel}
          setupURL="https://docs.dbsaicle.dev/autocomplete/model-setup"
        />
            ...
            <ModelRoleRow
              ...
              description={
                <span>
                  ...
                  <a
                    href="https://docs.dbsaicle.dev/features/edit/quick-start"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-inherit underline hover:brightness-125"
                  >
              ...
              onConfigure={handleConfigureModel}
              setupURL="https://docs.dbsaicle.dev/edit/model-setup"
            />
          </>
        )}
      </Card>
        ...
        >
          <div className="flex flex-col">
            <ModelRoleRow
              ...
              onConfigure={handleConfigureModel}
              setupURL="https://docs.dbsaicle.dev/customize/model-roles/apply"
            />
            ...
            <ModelRoleRow
              ...
              onConfigure={handleConfigureModel}
              setupURL="https://docs.dbsaicle.dev/customize/model-roles/embeddings"
            />
            ...
            <ModelRoleRow
              ...
              onConfigure={handleConfigureModel}
              setupURL="https://docs.dbsaicle.dev/customize/model-roles/reranking"
            />
          </div>
        </Toggle>
      </Card>
