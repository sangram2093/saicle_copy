...
import { isDbSaicleTeamMember } from "core/util/isDbSaicleTeamMember";
...
import { DbSaicleFeaturesMenu } from "../components/DbSaicleFeaturesMenu";
            ...
            <Card>
              <div className="flex flex-col gap-4">
                <UserSetting
                  ...
                  description="Allows DbSaicle to send anonymous telemetry."
              ...
              >
                <div className="flex flex-col gap-x-1 gap-y-4">
                  ...
                  <UserSetting
                    ...
                    description=" DbSaicle will not attempt to use native tool calling and will only use system message tools."
