...
export const modelCapabilitySchema = z.union([
  ...
  z.literal("next_edit"),
  z.string(), // Needed for forwards compatibility, see https://github.com/dbsaicledev/continue/pull/7676
]);
...
export const modelSchema = z.union([
  z.object({
    ...baseModelFields,
    provider: z.literal("dbsaicle-proxy"),
  ...
  z.object({
    ...baseModelFields,
    provider: z.string().refine((val) => val !== "dbsaicle-proxy"),
    sourceFile: z.string().optional(),
    region: z.string().optional(),
    projectId: z.string().optional(),
    keyfile_json_path: z.string().optional(),
    wif_json_path: z.string().optional(),
    dbllm_apikey: z.string().optional(),
    data_classification: z.string().optional(),
    dbllm_urlendpoint: z.string().optional(),
    kannon_id: z.string().optional(),
