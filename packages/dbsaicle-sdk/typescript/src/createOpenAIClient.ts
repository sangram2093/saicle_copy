...
interface OpenAIClientOptions extends Record<string, any> {
  ...
  /**
   * Whether to always use the DbSaicle-managed proxy for model requests
   */
  alwaysUseProxy?: boolean;

  /**
   * API key for DbSaicle Hub
   */
  apiKey?: string;
...
/**
 * Create and configure an OpenAI client that uses DbSaicle Hub for authentication
 *
...
export function createOpenAIClient({
  ...
  organizationId,
  apiKey,
  baseURL = "https://api.dbsaicle.dev/",
