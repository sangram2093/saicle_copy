import { RequestOptions } from "@dbsaicledev/config-types";
...
if (typeof http.Agent.prototype.getName !== "function") {
  http.Agent.prototype.getName = function (options: any) {
    const host = options.host || options.hostname;
    const port = options.port || (options.protocol === "https:" ? 443 : 80);
    return `${options.protocol}://${host}:${port}`;
  };
}

if (typeof https.Agent.prototype.getName !== "function") {
  https.Agent.prototype.getName = http.Agent.prototype.getName;
}
