...
import { IDbSaicleHubClient } from "./IDbSaicleHubClient.js";

interface DbSaicleHubClientOptions {
  apiKey?: string;
  apiBase?: string;
  fetchOptions?: RequestInit;
}

export class DbSaicleHubClient implements IDbSaicleHubClient {
  private readonly apiKey?: string;
  private readonly apiBase: string;
  private readonly fetchOptions?: RequestInit;

  constructor(options: DbSaicleHubClientOptions) {
    this.apiKey = options.apiKey;
    this.apiBase = options.apiBase ?? "https://api.dbsaicle.dev";
